...
// Version 1.0.1: Update no selected order text
// Version 1.0.2: Update add_ingredient should not return number of ingredients
// Version 1.0.3: Add assumptions to calculate_total_profit in response to bug
...
//
// The orders should be printed in the order they are in in the linked
// list.
//
